...
module.exports = {
    name: "support",
    description: "Obtiene el link de invitación del servidor de soporte",
    category: "misc",
    args: false,
    usage: ["support"],
    cooldown: 3,
    ...
    execute: async (client, message, args, prefix, guild, color, channel) => {
      ...
      .setTitle(`Comunidad PokeFree`)
      .setDescription(`**Click aquíi](${config.server}) para unirte al servidor de soporte..!!**`)
      .setColor(color)
