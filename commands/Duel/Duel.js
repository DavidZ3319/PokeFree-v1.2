    ...
    execute: async (client, message, args, prefix, guild, color, channel) => {
        ...
        collector.on('collect', async m => {
            if (m.content.toLowerCase() === prefix.toLowerCase() + "accept") {
                ...
                const ctx = canvas.getContext('2d');
                const background = await Canvas.loadImage(`https://cdn.discordapp.com/attachments/845192128208699452/845192151675174932/fight.png`);
                    ...
                    if (PokemonSpeed > pokemonTwoSpeed) {
                        ...
                        if (hp < 1) {
                            ...
                            embed
                                ...
                                .setColor(color)
                            return em.edit(embed)
                          message.channel.send(`Battle ended and ${message.author} won the Battle`)
                        }
                    }
...
}//https://discord.com/api/v10/webhooks/1014907712091455499/FBPO3tg8oXnx_PYp8Kx-MfnxdqJtwud0e7MHQGiCIdhnjmp66myEGoaOhQg9MHO5eGQf