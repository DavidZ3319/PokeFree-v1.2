  ...
  execute: async (client, message, args, prefix, guild, color, channel) => {
    ...
    if (gen <= 10) shiny = true;
        ...
        return message.channel.send(embed3)
          ...
          if (name.toLowerCase().startsWith("tornadus")) options.url = "https://pokeapi.co/api/v2/pokemon/tornadus-inhttps://pokeapi.co/api/v2/pokemon/tornadus-incarnatecarnate";
